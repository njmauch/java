...
public class MySqlUtility 
{
    ...
    * specified total length, it is truncated.
    * 
    ...
    */
    public static String padRight(String str, int iTotalLength, char padChar)
    {
        ...
        { // smaller so pad it
            ...
            str = str.substring(0,iTotalLength);
        return str;
    }
    ...
    */
    public static void printUtility(String title, ResultSet resultSet) throws SQLException 
    {
        ...
        for (int i = 1; i <= resultSet.getMetaData().getColumnCount(); i  += 1)
        {
            ...
            if (iNmSize > iColSize)
                    iColSize = iNmSize;
            if (iColSize > 32)   // arbitrary size due to catalogue tables
                iColSize = 32;
            switch (resultSet.getMetaData().getColumnType(i))
            {
                ...
                case java.sql.Types.DOUBLE:
                     // Reduce the size if the column Size > 12
                     if (iNmSize <= 12 && iColSize > 12)
                         iColSize = 12;
                     break;
            }
